...
namespace DoAnSimple
{
    public partial class frmCategory : UserControl
    {
        ...
        private void dGVCategory_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtDescription.Text = dGVCategory.Rows[e.RowIndex].Cells[2].Value.ToString();
        ...
        private void Display()
        {
            ...
            string sSql = "Select * From [Category] Order by [Id]";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string sSql = "DELETE FROM [Category] WHERE Id = @CategoryId";
